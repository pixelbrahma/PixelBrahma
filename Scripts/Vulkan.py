...
PIXELBRAHMA_VULKAN_VERSION = '1.2.170.0'
VULKAN_SDK_EXE_PATH = 'PixelBrahma/ThirdParty/VulkanSDK/VulkanSDK.exe'
...
def CheckVulkanSDK():
    if (VULKAN_SDK is None):
        ...
        InstallVulkanPrompt()
        return False
    elif (PIXELBRAHMA_VULKAN_VERSION not in VULKAN_SDK):
        print(f"Located Vulkan SDK at {VULKAN_SDK}")
        print(f"You don't have the correct Vulkan SDK version! (PixelBrahma requires {PIXELBRAHMA_VULKAN_VERSION})")
        InstallVulkanPrompt()
        return False
...
OutputDirectory = "PixelBrahma/ThirdParty/VulkanSDK"
